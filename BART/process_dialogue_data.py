...
def generate_input_output(data,SEP_TOKEN, hist_len=3):
    ...
    for datum in data:
        for k in range(0, len(datum["questions"])):
            ...
            dialogue, target = build_input_target(datum["story"], q_hist, a_hist,SEP_TOKEN)
...
if __name__ == "__main__":
    ...
    for file_name, ds in [
        ...
        dialogues = list(generate_input_output(data,SEP))
