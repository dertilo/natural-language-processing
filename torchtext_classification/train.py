...
def train_and_valid(lr_, sub_train_, sub_valid_):
    ...
    for epoch in range(num_epochs):
        ...
        print("")
        print("Valid - Accuracy: {}".format(run_test(sub_valid_)))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--dataset', default='AG_NEWS', choices=text_classification.DATASETS)
    ...
    print("Test - Accuracy: {}".format(run_test(test_dataset)))
